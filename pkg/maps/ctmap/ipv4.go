...
// NewCtKey4 creates a CtKey4 with the provided ip, source port, destination
// port, next header, and flags.
...
// Convert converts CtKey4Global fields between host bye order and map byte
// order.
